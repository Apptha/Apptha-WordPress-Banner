...
<link rel="stylesheet" href="<?php echo get_bloginfo('url') . '/wp-content/plugins/'.$folder_name.'/css/farbtastic.css'; ?>" type="text/css" />
<link rel="stylesheet" href="<?php echo get_bloginfo('url') . '/wp-content/plugins/'.$folder_name.'/css/colorbox.css'; ?>">
...
<script>
    ...
    function bann_wid()
    {
       var bann_ui_width = $('#banner_width').val();
       document.getElementById('featured').style.width = bann_ui_width+'px';
    }
    function bann_hei()
    {
        var bann_ui_height = $('#banner_height').val();
    ...
    function bann_hover()
    {
        var bann_ui_hover= $('#bgColorhover').val();
        $('#nav-fragment-1').css('color',bann_ui_hover);
    }
  ...
  function updateDesign()
    {
      ...
      banner.ajax({
       method:"POST",
       url: site_url+'/wp-content/plugins/'+folder_name+'/black&white/banner_temp_ajax.php',
...
<div style='display:none'>
		<div id='inline_example1' style='padding:10px; background:#fff;'>
                     <div style="padding-left:90px">
                         <form name="form_get_license" method="POST" action="">
                          <input type="text" name="get_license" id="get_license" value="">
                          <input type="submit" name="submit_license" id="submit_license" value="license">
                         </form>
                    </div>
                </div>
	</div>
...
<!--				<div class="state-preview corner-all ui-widget-header">abc</div>-->
			...
			<div class="theme-group-content corner-bottom clearfix display_none">
				...
				<div class="field-group clearfix">
					...
					<div class="hasPicker"><input type="text" name="fcHeader" id="fcHeader" onblur="bann_color()" class="hex" value="<?php echo $edit_banncolor;?>" size="6" style="background-color: rgb(34, 34, 34); color: rgb(255, 255, 255); "></div>
				</div>
			...
			<div class="theme-group-content corner-bottom clearfix display_none">
				<div class="field-group field-group-background clearfix">
					<label for="bgColorhover" class="background">Background color &amp; texture</label>
                                        <div class="hasPicker"><input type="text" name="bgColorhover" id="bgColorhover" class="hex" value="e6e6e6" style="background-color: rgb(230, 230, 230); color: rgb(0, 0, 0); " onblur="bann_hover();" value="<?php echo $edit_hover;?>"></div>
					
				</div>
                                <div class="field-group field-group-background clearfix">
					<label for="thumb_image" class="background">Thumb Text</label>
                                        <div class="hasPicker"><input type="text" name="thumb_text" id="thumb_text" class="hex"  style="background-color: rgb(230, 230, 230); color: rgb(0, 0, 0); "  value="<?php echo $edit_thumbcolor;?>"></div>
...
<!--				<div class="state-preview corner-all ui-state-hover">abc</div>-->
			...
			<div class="theme-group-content corner-bottom clearfix" style="display: none; ">
				...
				<div class="field-group field-group-border clearfix">
					...
					<div class="hasPicker"><input type="text" name="banner_width" id="banner_width"  value="<?php echo $edit_width; ?>" size="6" onblur="bann_wid();"></div>
				</div>
				<div class="field-group clearfix">
					<label for="borderHeight">Height</label>
					<div class="hasPicker"><input type="text" name="banner_height" id="banner_height" value="<?php echo $edit_height; ?>" size="6" onblur="bann_hei();"></div>
				</div>
                                <div class="field-group clearfix">
...
<?php
$reqbanner = '../wp-content/plugins'.DIRECTORY_SEPARATOR.$folder_name.DIRECTORY_SEPARATOR.'black&white/black&white.php';
