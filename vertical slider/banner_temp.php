...
<p><a href="#mydiv" rel="facebox"><img src="<?php echo $site_url . '/wp-content/plugins/'.$folder_name.'/image/licence.png'?>" align="right"></a></p>
<?php
}
?>
  ...
  function updateDesign()
    {
      ...
      banner.ajax({
       method:"GET",
       url: site_url+'/wp-content/plugins/'+folder_name+'/vertical slider/banner_temp_ajax.php',
       data : "&bann_style="+bann_style+"&bgcolor="+bgcolor+"&bordercolor="+bordercolor+
           ...
           "&corner="+cornerradius+"&bann_borsize="+bann_borsize+"&bann_caption="+banncaption+"&bannspacing="+bannspacing+"&bann_timing="+bann_timing,
       asynchronous:false,
       success: function() {
...
<?php
$reqbanner = '../wp-content/plugins'.DIRECTORY_SEPARATOR.$folder_name.DIRECTORY_SEPARATOR.'vertical slider/vertical slider.php';
