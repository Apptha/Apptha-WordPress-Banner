  ...
  function updateDesign()
    {
      ...
      banner.ajax({
       method:"GET",
       url: site_url+'/wp-content/plugins/'+folder_name+'/navo slider/banner_temp_ajax.php',
       data : "bann_style="+bann_style+"&bordercolor="+bordercolor+"&bannwidth="+bannwidth+"&bannheight="+bannheight+
           "&corner="+cornerradius+"&bann_borsize="+bann_borsize+"&bannspacing="+bannspacing+"&bann_timing="+bann_timing,
       asynchronous:false,
       success: function() {
			...
			<div class="theme-group-content corner-bottom clearfix display_none">
				...
				<div class="field-group clearfix">
					...
					<input type="text" name="bannerborder" id="bannerborder" value="<?php echo $edit_brdsize;?>" size="3" onblur="bann_borsize();">
                            ...
                            <div class="field-group clearfix">
					<label for="borderColorHeader">color</label>
...
<?php
$reqbanner = '../wp-content/plugins'.DIRECTORY_SEPARATOR.$folder_name.DIRECTORY_SEPARATOR.'plain image/plain image.php';
